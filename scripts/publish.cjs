...
execFileSync(process.execPath,['--test','tests/core.test.cjs','tests/laputa.test.cjs','tests/advanced.test.cjs','tests/scars.test.cjs','tests/cmajor.test.cjs'],{stdio:'inherit'});
const parent=[];
