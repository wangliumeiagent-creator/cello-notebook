...
const maySong=song('may-song','五月之歌','May Song',9,'D3:1.5 F#3:.5 A3 D4 | B3 D4:.5 B3:.5 A3:2 | G3:1.5 A3:.5 F#3 D3 | E3:2 D3:2 | A3 A3 G3 F#3 | F#3 A3:.5 F#3:.5 E3:2 | A3 A3 G3 F#3 | F#3 A3:.5 F#3:.5 E3:2 | D3:1.5 F#3:.5 A3 D4 | B3 D4:.5 B3:.5 A3:2 | G3:1.5 A3:.5 F#3 D3 | E3:2 D3:2',{tempo:80,tempoLabel:'Allegro moderato',repeat:true,dynamic:'f',focus:'附点节奏、D/A 弦跨弦与强弱对比',description:'铃木第一册 · D 大调 · 第一把位 · D / A 弦 · 教材第 9 页',sections:[{label:'主题起句',from:1,to:4},{label:'中段对比',from:5,to:8},{label:'主题再现',from:9,to:12}],theory:[{title:'附点四分音符先数满',body:'第 1、3、9、11 小节开头的附点四分音符占一拍半，随后八分音符占半拍；合起来正好两拍。不要把第一个音缩短。',task:'先拍“1 和 2”，在“2”进入后面的八分音符。'},{title:'D、A 弦的跨弦准备',body:'旋律在 D 弦与 A 弦之间转换。先看清弦号与指法，再让右臂提前准备下一根弦；不要靠突然加速换弦。',task:'循环第 1–2 小节，先慢速练 D3–F♯3–A3–D4 的上行。'},{title:'强弱与第二遍收束',body:'教材从 f 开始，第 5 小节转为 mf，第 7 小节转为 p，第 9 小节回到 f。第二遍结尾有 poco rit.，网页保持稳定拍点作为核对参考。',task:'先用 60 拍练完整一遍，再在老师指导下加入力度和末尾渐慢。'}],practiceTips:['先以 40 或 60 拍分段读谱；“Allegro moderato”不表示一开始就要快速拉。','第 1 小节教材标出下弓与上弓，其他弓向请按课堂要求处理。','末尾按教材反复；第二遍结尾标有 poco rit.，以老师的速度安排为准。']});
maySong.bars[0][0].bow='down';maySong.bars[0][1].bow='up';maySong.bars[4][0].expression='mf';maySong.bars[6][0].expression='p';maySong.bars[8][0].expression='f';maySong.bars[11][0].expression='poco rit.（第二遍）';
lessons.splice(1,0,twinkle,...variations,children,maySong,rhody,row);
